...
if __name__ == "__main__":
    ...
    variant = dict(
        ...
        algorithm_kwargs=dict(
            num_epochs=3, # 3000,
            num_eval_steps_per_epoch=1, # =1000,
    ...
    parser.add_argument('--buffer_filename', type=str, default='/home/kg/Projects/off/d4rl/d4rl/maze2d-large-dense-v1-waypoint-1.hdf5')
    parser.add_argument('--starts_and_targets_path', type=str, default='/home/kg/Projects/off/d4rl/d4rl/st-maze2d-large-dense-v1-2.hdf5',
                        help='Path to starts and targets file')

    args = parser.parse_args()
    enable_gpus(args.gpu)

    variant['starts_and_targets_path'] = args.starts_and_targets_path
    ...
    setup_logger(os.path.join('CQL_offline_mujoco_runs', str(rnd)), variant=variant, base_log_dir='/home/kg/Projects/off/CQL/d4rl/random_expert_CQL_runs')
